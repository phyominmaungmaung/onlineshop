...
{{--DataTable--}}
    <link rel="stylesheet" href="{{url('bower_components/bootstrap/dist/css/dataTable.bootstrap.min.css')}}">
...
{{--DataTable--}}
<script src="{{url('bower_components/bootstrap/dist/js/jquery.dataTable.min.js')}}"></script>
<script src="{{url('bower_components/bootstrap/dist/js/dataTable.bootstrap.min.js')}}"></script>
<script>
    $(function () {
        $('#dt').dataTable();
    })
